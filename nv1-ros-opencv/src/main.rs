    ...
    let opencv_handle = task::spawn(async move {
        ...
        loop {
            ...
            if cap_front.read(&mut frame_front)? {
                ...
                cudaarithm::bitwise_not(&gpu_frame_front, &mut gpu_tmp, &gpu_mask, &mut stream)?;
                ...
                for i in 1..stats.rows() {
                    ...
                    if *area > 2000 {
                        ...
                        let width = stats.at_pt::<i32>(Point::new(imgproc::CC_STAT_WIDTH, i))?;
                        let height = stats.at_pt::<i32>(Point::new(imgproc::CC_STAT_HEIGHT, i))?;
